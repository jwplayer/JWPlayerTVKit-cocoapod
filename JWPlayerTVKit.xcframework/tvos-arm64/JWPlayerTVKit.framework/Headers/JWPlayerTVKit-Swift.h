...
#ifndef JWPLAYERTVKIT_SWIFT_H
#define JWPLAYERTVKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="JWPlayerTVKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit12JWAVDelegate_")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit19JWAccessLogMetadata")
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit27JWAccessLogMetadataDelegate_")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit9JWAdBreak")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit16JWAdBreakBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit13JWAdCompanion")
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit12JWAdDelegate_")
...
///
- (void)jwplayer:(id <JWPlayer> _Nonnull)player adEvent:(JWAdEvent * _Nonnull)event;
@end
...
SWIFT_CLASS("_TtC13JWPlayerTVKit9JWAdEvent")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit14JWAdImpression")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit18JWAdInterfaceStyle")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit25JWAdInterfaceStyleBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit10JWAdOffset")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit9JWAdRules")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit16JWAdRulesBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit12JWAdSettings")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit19JWAdSettingsBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit17JWAdTrackerConfig")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit29JWAdsAdvertisingConfigBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit19JWAdvertisingConfig")
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit17JWAirPlayDelegate_")
...
typedef SWIFT_ENUM(NSInteger, JWButtonType, open) {
  JWButtonTypeCaption = 0,
  JWButtonTypeAudio = 1,
  JWButtonTypePictureInPicture = 2,
  JWButtonTypeTabItem = 3,
};
...
SWIFT_CLASS("_TtC13JWPlayerTVKit17JWCaptionPosition")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit24JWCaptionPositionBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit14JWCaptionStyle")
...
/// If <code>true</code>, the side-loaded captions will be enlarged for large player sizes such as when the player is full screen. If <code>false</code>, the captions will
/// retain their default assigned size, whether that is from the defined style by the developer or from the user’s accessibility settings.
/// This property is <code>true</code> by default.
@property (nonatomic, readonly) BOOL allowScaling;
/// This init is internal so external developers cannot create this structure on their own.
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC13JWPlayerTVKit21JWCaptionStyleBuilder")
...
/// retain their default assigned size, whether that is from the defined style by the developer or from the user’s accessibility settings.
/// note:
/// This only affects the rendering of side-loaded captions.
/// \param allowed If <code>true</code>, the captions will scale. If <code>false</code>, the captions will not scale. The default value is <code>true</code>.
///
///
/// returns:
/// The builder, so setters can be chained.
...
SWIFT_CLASS("_TtC13JWPlayerTVKit12JWMediaTrack")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit14JWCaptionTrack")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit21JWCaptionTrackBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit14JWChapterTrack")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit21JWChapterTrackBuilder")
...
/// These events are triggered by the time values specified within the chapter media track VTT file.
/// In order for the chapter beginning and ending events to be as accurate as possible, it is advisable that the chapter media track
/// file define the chapters with accurate beginning and ending time values.
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit18JWChaptersDelegate_")
@protocol JWChaptersDelegate
/// Reports when the player has loaded the chapter cues.
/// \param player The player emitting the event.
///
/// \param chapters The chapters belonging to the current media.
///
- (void)jwplayer:(id <JWPlayer> _Nonnull)player loadedChapters:(NSArray<JWCue *> * _Nonnull)chapters;
/// Reports when the player has entered a chapter.
/// \param player The player emitting the event.
///
/// \param chapter The description of the chapter which is beginning.
///
- (void)jwplayer:(id <JWPlayer> _Nonnull)player beganChapter:(JWCue * _Nonnull)chapter;
/// Reports when the player has progressed past the end of a chapter.
/// \param player The player emitting the event.
///
/// \param chapter The description of the chapter which is ending.
///
- (void)jwplayer:(id <JWPlayer> _Nonnull)player endedChapter:(JWCue * _Nonnull)chapter;
@end
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit22JWRelatedEventDelegate_")
@protocol JWRelatedEventDelegate
/// Reports when a new playlist of related items is loaded from a feed.
/// \param player The player emitted the event.
///
/// \param playlist The related playlist.
///
- (void)jwplayer:(id <JWPlayer> _Nonnull)player loadedRelatedPlaylist:(NSArray<JWPlayerItem *> * _Nonnull)playlist;
/// Reports when a related nextup item is loaded.
/// \param player The player emitted the event.
///
/// \param item The next related playlist item.
///
- (void)jwplayer:(id <JWPlayer> _Nonnull)player loadedNextUpItem:(JWPlayerItem * _Nonnull)item;
/// Reports when the player has began to play a related item.
/// \param player The player emitted the event.
///
/// \param item The related item.
///
/// \param index The related playlist index.
///
/// \param method How the related item began playing.
///
- (void)jwplayer:(id <JWPlayer> _Nonnull)player relatedItemBeganPlaying:(JWPlayerItem * _Nonnull)item atIndex:(NSInteger)index withMethod:(enum JWRelatedMethod)method;
@end


/// A protocol for listening to time events through the JWPlayerViewController.
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit19JWTimeEventListener_")
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit33JWProgramDateTimeMetadataDelegate_")
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit20JWPlayerViewDelegate_")
...
enum JWPlayReason : NSInteger;
enum JWPauseReason : NSInteger;
enum JWIdleReason : NSInteger;
enum JWMediaType : NSInteger;
@class JWSkippableTimeRange;
...
///   </li>
/// </ul>
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit21JWPlayerStateDelegate_")
...
/// \param player The player emitting the event.
///
/// \param range The description of the skippable time range.
///
- (void)jwplayer:(id <JWPlayer> _Nonnull)player enteredSkippableRange:(JWSkippableTimeRange * _Nonnull)range SWIFT_AVAILABILITY(tvos,introduced=14) SWIFT_AVAILABILITY(ios,unavailable);
@end


/// A protocol which must be used to monitor errors within the JWPlayer instance.
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit16JWPlayerDelegate_")
...
@class JWMediaMetadata;

/// Listens for media metadata when the video is done loading
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit23JWMediaMetadataDelegate_")
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit21JWID3MetadataDelegate_")
...
@class JWExternalMetadata;

/// Listens for metadata events defined by the developer during playback.
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit26JWExternalMetadataDelegate_")
...
@class JWDateRangeMetadata;

/// Listens for date range metadata events during playback.
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit27JWDateRangeMetadataDelegate_")
...
@protocol JWPlayerCinematicViewControllerDelegate;
@class UIImage;
@class JWLogo;
enum JWInterfaceBehavior : NSInteger;
@class JWNextUpStyle;
@class NSCoder;
enum JWLabelType : NSInteger;
enum JWViewType : NSInteger;
...
SWIFT_CLASS("_TtC13JWPlayerTVKit25JWCinematicViewController")
@interface JWCinematicViewController : UIViewController <AVPictureInPictureControllerDelegate, JWAVDelegate, JWAccessLogMetadataDelegate, JWAdDelegate, JWAirPlayDelegate, JWChaptersDelegate, JWDateRangeMetadataDelegate, JWExternalMetadataDelegate, JWID3MetadataDelegate, JWMediaMetadataDelegate, JWPlayerDelegate, JWPlayerStateDelegate, JWPlayerViewDelegate, JWProgramDateTimeMetadataDelegate, JWRelatedEventDelegate, JWTimeEventListener>
/// The player instance.
...
@property (nonatomic, weak) id <JWPlayerCinematicViewControllerDelegate> _Nullable delegate;
/// Enables the lock screen controls to be synchronized with this player. The default is <code>true</code>.
...
/// note:
/// The default value is “This video cannot be played because of a problem with your internet connection.” which corresponds to the localizable string <code>jwplayer_errors_bad_connection</code>.
...
/// \param font The font to set the label to. If <code>nil</code>, the default is used.
///
...
/// \param color The color to set the label’s text color to.
///
/// \param label The label to set the text color of.
///
- (void)setTextColor:(UIColor * _Nullable)color label:(enum JWLabelType)label;
/// Sets the font of a button on the player.
/// \param font The font to set the button to. If <code>nil</code>, the default is used.
///
/// \param state The state for the font to be applied to.
///
/// \param button The button to set the font of.
///
...
/// \param color The color to set the button’s title color to.
///
/// \param state The state for the color to be applied to.
///
/// \param button The button to set the title color of.
///
...
/// \param color The color to set the button’s color to. If <code>nil</code>, the default is used.
///
/// \param button The button to set the tint color of.
///
...
/// \param color The color to set the view’s background color to. If <code>nil</code>, the default is used.
///
/// \param view The view to set the background color of.
///
...
- (void)playerView:(JWPlayerView * _Nonnull)view sizeChangedFrom:(CGSize)oldSize to:(CGSize)newSize;
- (void)controlBarVisibilityChangedWithIsVisible:(BOOL)isVisible;
- (void)jwplayerIsReady:(id <JWPlayer> _Nonnull)player;
- (void)jwplayer:(id <JWPlayer> _Nonnull)player failedWithError:(NSUInteger)code message:(NSString * _Nonnull)message;
- (void)jwplayer:(id <JWPlayer> _Nonnull)player failedWithSetupError:(NSUInteger)code message:(NSString * _Nonnull)message;
- (void)jwplayer:(id <JWPlayer> _Nonnull)player encounteredWarning:(NSUInteger)code message:(NSString * _Nonnull)message;
...
- (void)jwplayerHasSeeked:(id <JWPlayer> _Nonnull)player;
- (void)jwplayer:(id <JWPlayer> _Nonnull)player playbackRateChangedTo:(double)rate at:(NSTimeInterval)time;
- (void)jwplayer:(id <JWPlayer> _Nonnull)player enteredSkippableRange:(JWSkippableTimeRange * _Nonnull)range;
- (void)jwplayer:(id <JWPlayer> _Nonnull)player updatedCues:(NSArray<JWCue *> * _Nonnull)cues;
- (void)onMediaTimeEvent:(JWTimeData * _Nonnull)time;
- (void)onAdTimeEvent:(JWTimeData * _Nonnull)time;
- (void)jwplayer:(id <JWPlayer> _Nonnull)player audioTracksUpdated:(NSArray<JWMediaSelectionOption *> * _Nonnull)levels;
...
SWIFT_CLASS("_TtC13JWPlayerTVKit17JWCompanionAdSlot") SWIFT_AVAILABILITY(tvos,unavailable)
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit15JWJSONEncodable_")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit5JWCue")
@interface JWCue : NSObject <JWJSONEncodable>
...
SWIFT_CLASS("_TtC13JWPlayerTVKit9JWCueTime")
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit25JWDRMContentKeyDataSource_")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit19JWDateRangeMetadata")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit7JWError")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit18JWExternalMetadata")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit26JWExternalPlaybackSettings")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit33JWExternalPlaybackSettingsBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit21JWFriendlyObstruction")
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit28JWFriendlyObstructionManager_")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit31JWFriendlyObstructionsContainer")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit17JWGoogleDAIStream")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit24JWGoogleDAIStreamBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit13JWID3Metadata")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit29JWImaAdvertisingConfigBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit32JWImaDaiAdvertisingConfigBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit13JWImaSettings")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit20JWImaSettingsBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit12JWJSONParser")
...
typedef SWIFT_ENUM(NSInteger, JWLabelType, open) {
  JWLabelTypeTitle = 0,
  JWLabelTypeSubtitle = 1,
  JWLabelTypeCollectionItemTitle = 2,
  JWLabelTypeCollectionItemSubtitle = 3,
  JWLabelTypeNextUpCountdown = 4,
  JWLabelTypeMenuTitle = 5,
  JWLabelTypeMenuItem = 6,
  JWLabelTypePosition = 7,
  JWLabelTypeRemainingTime = 8,
  JWLabelTypePlaybackRate = 9,
};
...
SWIFT_CLASS("_TtC13JWPlayerTVKit19JWLockScreenManager")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit6JWLogo")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit13JWLogoBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit15JWMediaMetadata")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit22JWMediaSelectionOption")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit11JWMenuStyle")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit18JWMenuStyleBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit19JWMetadataDelegates")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit13JWNextUpStyle")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit20JWNextUpStyleBuilder")
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit16JWPlayerProtocol_")
@protocol JWPlayerProtocol
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit8JWPlayer_")
...
@property (nonatomic, strong) id <JWChaptersDelegate> _Nullable chaptersDelegate;
...
@property (nonatomic, strong) id <JWRelatedEventDelegate> _Nullable relatedEventDelegate;
@end


/// A description of an ad impression from the JW Player Ad Client.
SWIFT_CLASS("_TtC13JWPlayerTVKit20JWPlayerAdImpression")
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit39JWPlayerCinematicViewControllerDelegate_")
@protocol JWPlayerCinematicViewControllerDelegate
/// Called when the control bar is done hiding or showing itself.
/// \param controller The JWCinematicViewController emitting the event.
///
/// \param isVisible true, if the control bar has finished showing itself. false if it has finished hiding itself.
///
- (void)playerViewController:(JWCinematicViewController * _Nonnull)controller controlBarVisibilityChanged:(BOOL)isVisible;
/// Called when the player’s dimensions have changed.
/// \param controller The JWCinematicViewController emitting the resize event.
///
/// \param oldSize The previous size of the player view.
///
/// \param newSize The new size of the player on the screen.
///
- (void)playerViewController:(JWCinematicViewController * _Nonnull)controller sizeChangedFrom:(CGSize)oldSize to:(CGSize)newSize;
@end


/// Configuration object used to create a <code>JWPlayer</code> instance.
SWIFT_CLASS("_TtC13JWPlayerTVKit21JWPlayerConfiguration")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit28JWPlayerConfigurationBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit12JWPlayerItem")
@interface JWPlayerItem : NSObject <JWJSONEncodable>
...
/// An array of skippable time ranges within the content.
@property (nonatomic, readonly, copy) NSArray<JWSkippableTimeRange *> * _Nonnull skippableTimeRanges SWIFT_AVAILABILITY(tvos,introduced=14) SWIFT_AVAILABILITY(ios,unavailable);
...
@property (nonatomic, readonly, copy) NSArray<JWCaptionTrack *> * _Nonnull captionTracks;
/// Returns a thumbnail track, if it exists.
@property (nonatomic, readonly, strong) JWMediaTrack * _Nullable thumbnailTrack;
/// This init is internal so external developers cannot create this structure on their own.
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (NSDictionary<NSString *, id> * _Nonnull)toJSONObject SWIFT_WARN_UNUSED_RESULT;
/// Calling this method converts the <code>JSONObject</code> into a <code>JWPlayerItem</code>.
///
/// returns:
...
SWIFT_CLASS("_TtC13JWPlayerTVKit19JWPlayerItemBuilder")
...
@interface JWPlayerItemBuilder (SWIFT_EXTENSION(JWPlayerTVKit))
/// Sets the skippable time ranges within the item.
/// \param timeRanges The time ranges which the user can skip.
///
///
/// returns:
/// The builder, so setters can be chained.
- (JWPlayerItemBuilder * _Nonnull)skippableTimeRanges:(NSArray<JWSkippableTimeRange *> * _Nonnull)timeRanges SWIFT_AVAILABILITY(tvos,introduced=14) SWIFT_AVAILABILITY(ios,unavailable);
@end


/// JWPlayerKitLicense is a static interface into our SDK for accomplishing basic tasks outside of a JWPlayer instance.
SWIFT_CLASS("_TtC13JWPlayerTVKit18JWPlayerKitLicense")
...
SWIFT_PROTOCOL("_TtP13JWPlayerTVKit20JWPlayerViewProtocol_")
@protocol JWPlayerViewProtocol
...
SWIFT_CLASS("_TtC13JWPlayerTVKit12JWPlayerView")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit25JWProgramDateTimeMetadata")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit29JWRelatedContentConfiguration")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit36JWRelatedContentConfigurationBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit20JWSkippableTimeRange") SWIFT_AVAILABILITY(tvos,introduced=14) SWIFT_AVAILABILITY(ios,unavailable)
@interface JWSkippableTimeRange : NSObject
/// A time range over which a skip button is displayed.
@property (nonatomic, readonly, strong) JWTimeRange * _Nonnull buttonDisplayTime;
...
SWIFT_CLASS("_TtC13JWPlayerTVKit27JWSkippableTimeRangeBuilder") SWIFT_AVAILABILITY(tvos,introduced=14) SWIFT_AVAILABILITY(ios,unavailable)
@interface JWSkippableTimeRangeBuilder : NSObject
...
///   </li>
///   <li>
///     returns A <code>JWSkippableTimeRange</code> object.
///   </li>
/// </ul>
- (JWSkippableTimeRange * _Nullable)buildAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
/// Sets the time range during which to display the skip button.
/// \param timeRange The beginning and end time.
///
///
/// returns:
/// The builder, so setters can be chained.
- (JWSkippableTimeRangeBuilder * _Nonnull)buttonDisplayTime:(JWTimeRange * _Nonnull)timeRange;
/// Sets the time in the video to seek to when the skip button is tapped.
/// \param seconds The position to see to in the video, expressed in seconds from the beginning of the media.
///
///
/// returns:
/// The builder, so setters can be chained.
- (JWSkippableTimeRangeBuilder * _Nonnull)seekToTime:(NSTimeInterval)seconds;
/// Sets the text to be displayed on the skip button.
/// \param text The text to display on the skip button.
///
///
/// returns:
/// The builder, so setters can be chained.
- (JWSkippableTimeRangeBuilder * _Nonnull)buttonText:(NSString * _Nonnull)text;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// The builder for creating a JWMediaTrack used for thumbnails.
SWIFT_CLASS("_TtC13JWPlayerTVKit23JWThumbnailTrackBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit10JWTimeData")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit11JWTimeRange")
...
/// Defines the style for the control bar on a player.
SWIFT_CLASS("_TtC13JWPlayerTVKit17JWTimeSliderStyle")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit24JWTimeSliderStyleBuilder")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit13JWVideoSource")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit20JWVideoSourceBuilder")
...
typedef SWIFT_ENUM(NSInteger, JWViewType, open) {
  JWViewTypeInfoCard = 0,
  JWViewTypeNextUpCard = 1,
  JWViewTypeMenu = 2,
  JWViewTypeTabBar = 3,
};
...
SWIFT_CLASS("_TtC13JWPlayerTVKit15JWVisualQuality")
...
SWIFT_CLASS("_TtC13JWPlayerTVKit20JWVisualQualityLevel")
...
@interface UIStackView (SWIFT_EXTENSION(JWPlayerTVKit))
