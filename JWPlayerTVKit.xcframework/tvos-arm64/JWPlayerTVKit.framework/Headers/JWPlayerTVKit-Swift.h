...
@interface JWCinematicViewController : UIViewController <AVPictureInPictureControllerDelegate, JWAVDelegate, JWAccessLogMetadataDelegate, JWAdDelegate, JWAirPlayDelegate, JWDateRangeMetadataDelegate, JWExternalMetadataDelegate, JWID3MetadataDelegate, JWMediaMetadataDelegate, JWPlayerDelegate, JWPlayerStateDelegate, JWPlayerViewDelegate, JWProgramDateTimeMetadataDelegate, JWTimeEventListener>
/// The player instance.
